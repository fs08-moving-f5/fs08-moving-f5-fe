...
export default function InputSearchBar({ size = 'md', handleSubmit }: InputProps) {
  ...
  const inputSize = {
    sm: 'h-[52px] w-[260px] pl-[46px] pr-[16px] py-[14px] group-focus-within:pl-[16px] group-focus-within:pr-[76px]',
    md: 'h-[64px] w-[560px] pl-[68px] pr-[24px] py-[14px] group-focus-within:pl-[24px] group-focus-within:pr-[112px]',
  };
  ...
  return (
    <form
      ...
      className={`group relative flex h-fit w-fit items-center justify-start`}
    >
      <input
        type="text"
        value={value}
